...
public:
    ...
    [[nodiscard]] std::shared_ptr<DataPointValue>
    convertDuoResponseToDataPoint(const google::protobuf::Value& item) const {
        return duo::DuoTypeConverter::fromDuoValue(*this, item);
    }
};
