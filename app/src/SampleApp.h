...
public:
    ...
    /**
     * @brief Handle speed changed events.
     *
     * @param reply  The data point reply.
     */
    void onSpeedChanged(const velocitas::DataPointReply& reply);

    /**
     * @brief Handle generic data point changes.
     *
     * @param signalPath  The path of the changed signal.
     * @param reply  The data point reply.
     */
    void onDataPointChanged(const std::string& signalPath, const velocitas::DataPointReply& reply);
